...
import static com.alphawallet.app.steps.Steps.sendNFTTo;
...
public class TransferERC721Test extends BaseE2ETest
{
    ...
    private void deployTestTokenOnGanache()
    {
        ...
        EthUtils.deployContract(web3j, contractOwnerCredentials, Contracts.erc721ContractCode);
