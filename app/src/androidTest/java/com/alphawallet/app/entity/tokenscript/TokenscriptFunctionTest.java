...
public class TokenscriptFunctionTest implements ParseResult {
    ...
    private final String entryTokenTestFile = "<ts:token xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:ts=\"http://tokenscript.org/2019/10/tokenscript\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" custodian=\"false\" xsi:schemaLocation=\"http://tokenscript.org/2019/07/tokenscript\">\n" +
            ...
            "      </ts:name>\n" +
            "      <ts:exclude selection=\"expired\"></ts:exclude>\n" +
            "      <style type=\"text/css\">\t.ts-count {\n" +
            "\t  font-family: \"SourceSansPro\";\n" +
            "\t  font-weight: bolder;\n" +
            "\t  font-size: 21px;\n" +
            ...
            "      <ts:origins>\n" +
            "        <ts:ethereum contract=\"EntryToken\" function=\"getLocality\" as=\"utf8\">\n" +
            "            <ts:data>\n" +
            ...
            "      </ts:name>\n" +
            "      <ts:origins>\n" +
            "        <ts:token-id bitmask=\"000000000000000000000000000000000000FFFFFFFF00000000000000000000\" as=\"mapping\"/>\n" +
            "        <ts:mapping>\n" +
            ...
            "      <ts:origins>\n" +
            "        <ts:ethereum contract=\"EntryToken\" function=\"isExpired\" as=\"bool\">\n" +
            "          <ts:data>\n" +
            "            <ts:uint256 ref=\"tokenId\"></ts:uint256>\n" +
            "          </ts:data>\n" +
            "        </ts:ethereum>\n" +
            ...
            "      <ts:origins>\n" +
            "        <ts:ethereum contract=\"EntryToken\" function=\"getBuildingName\" as=\"utf8\">\n" +
            "          <ts:data>\n" +
            "            <ts:uint256 ref=\"tokenId\"></ts:uint256>\n" +
            "          </ts:data>\n" +
            "        </ts:ethereum>\n" +
            ...
            "      <ts:origins>\n" +
            "        <ts:ethereum contract=\"EntryToken\" function=\"getState\" as=\"utf8\">\n" +
            "          <ts:data>\n" +
            "            <ts:uint256 ref=\"tokenId\"></ts:uint256>\n" +
            "          </ts:data>\n" +
            "        </ts:ethereum>\n" +
