                                                                    ...
                                                                    Runnable, ActionSheetCallback
{
    ...
    private void displayTokens()
    {
        ...
        adapter = new NonFungibleTokenAdapter(functionBar, token, viewModel.getAssetDefinitionService(),viewModel.getJsonSettingService(), viewModel.getOpenseaService(), this);
        functionBar.setupFunctions(this, viewModel.getAssetDefinitionService(), token, adapter, token.getArrayBalance());
        functionBar.setWalletType(wallet.type);
