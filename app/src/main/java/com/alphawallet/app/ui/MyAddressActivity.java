...
public class MyAddressActivity extends BaseActivity implements AmountReadyCallback
{
    ...
    private void showAddress()
    {
        ...
        updateAddressWithENS(wallet.name); //JB: see if there's any cached value to display while we wait for ENS
    ...
    private void printTrace(Throwable throwable) {
        ...
        updateAddressWithENS(wallet.name); // JB: if there's any issue then fall back to cached name
    }
