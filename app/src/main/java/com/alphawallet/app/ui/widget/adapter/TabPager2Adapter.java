...
public class TabPager2Adapter extends FragmentStateAdapter {

    private final List<Pair<String, Fragment>> pages;

    public TabPager2Adapter(@NonNull FragmentActivity fragmentActivity, List<Pair<String, Fragment>> pages) {
