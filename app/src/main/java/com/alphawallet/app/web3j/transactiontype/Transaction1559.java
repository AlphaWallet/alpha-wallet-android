 ...
 */
package com.alphawallet.app.web3j.transactiontype;
...
import static com.alphawallet.app.web3j.transactiontype.TransactionType.EIP1559;
...
public class Transaction1559 extends LegacyTransaction implements ITransaction {
    ...
    public List<RlpType> asRlpValues(Sign.SignatureData signatureData) {
        ...
        if (signatureData != null) {
            result.add(RlpString.create(getRecId(signatureData, getChainId())));
