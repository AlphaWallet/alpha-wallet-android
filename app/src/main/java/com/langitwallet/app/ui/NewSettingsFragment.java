...
import static com.langitwallet.app.C.CHANGED_LOCALE;
import static com.langitwallet.app.C.CHANGE_CURRENCY;
import static com.langitwallet.app.C.EXTRA_CURRENCY;
import static com.langitwallet.app.C.EXTRA_LOCALE;
import static com.langitwallet.app.C.EXTRA_STATE;
import static com.langitwallet.app.C.Key.WALLET;
import static com.langitwallet.app.C.RESET_WALLET;
import static com.langitwallet.app.C.SETTINGS_INSTANTIATED;
import static com.langitwallet.app.entity.BackupOperationType.BACKUP_HD_KEY;
import static com.langitwallet.app.entity.BackupOperationType.BACKUP_KEYSTORE_KEY;
...
import com.langitwallet.app.entity.BackupOperationType;
...
import com.langitwallet.app.viewmodel.NewSettingsViewModel;
import com.langitwallet.app.widget.NotificationView;
...
public class NewSettingsFragment extends BaseFragment
{
    ...
    private SettingsItemView logoutSetting;
    ...
    private void initViewModel()
    {
        ...
        viewModelHome = new ViewModelProvider(this)
...
//                        .build();
        ...
        logoutSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(0)
                        .withTitle(R.string.logout)
                        .withListener(this::onLogoutSettingClicked)
                        .build();
    }
    ...
    private void addSettingsToLayout()
    {
        ...
        supportSettingsLayout.addView(logoutSetting, supportIndex++);
    ...
    private void onLogoutSettingClicked() {
        mGoogleSignInClient.signOut().addOnCompleteListener(getActivity(), new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                viewModelHome.splashReset().observe(getActivity(), this::onRequireInit);
