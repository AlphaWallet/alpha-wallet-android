...
import static com.langitwallet.app.C.IMPORT_REQUEST_CODE;
import static com.langitwallet.app.C.RC_SIGN_IN;
...
import com.langitwallet.app.util.RootUtil;
import com.langitwallet.app.viewmodel.SplashViewModel;
...
public class SplashActivity extends BaseActivity implements CreateWalletCallbackInterface, Runnable
{
    ...
    private void onWallets(Wallet[] wallets)
    {
        ...
        if (wallets.length == 0)
        {
            ...
            findViewById(R.id.button_login_with_google).setOnClickListener(v -> {
                new ImportWalletRouter().loginWithGoogle(this, mGoogleSignInClient);
            });
        }
        else
        {
