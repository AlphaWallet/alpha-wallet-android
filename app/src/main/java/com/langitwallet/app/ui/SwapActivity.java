...
import com.langitwallet.app.entity.analytics.TokenSwapEvent;
import com.langitwallet.app.entity.lifi.Chain;
import com.langitwallet.app.entity.lifi.Connection;
import com.langitwallet.app.entity.lifi.Quote;
import com.langitwallet.app.entity.lifi.Token;
import com.langitwallet.app.service.GasService;
import com.langitwallet.app.ui.widget.entity.ActionSheetCallback;
import com.langitwallet.app.ui.widget.entity.ProgressInfo;
import com.langitwallet.app.util.BalanceUtils;
import com.langitwallet.app.util.SwapUtils;
import com.langitwallet.app.viewmodel.SwapViewModel;
import com.langitwallet.app.viewmodel.Tokens;
...
import com.langitwallet.app.widget.SelectTokenDialog;
import com.langitwallet.app.widget.StandardHeader;
import com.langitwallet.app.widget.SwapSettingsDialog;
import com.langitwallet.app.widget.TokenInfoView;
import com.langitwallet.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.langitwallet.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.langitwallet.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
