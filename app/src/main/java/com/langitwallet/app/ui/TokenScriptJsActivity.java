...
import com.langitwallet.app.entity.GasEstimate;
...
import com.langitwallet.app.util.ShortcutUtils;
import com.langitwallet.app.viewmodel.DappBrowserViewModel;
import com.langitwallet.app.viewmodel.TokenFunctionViewModel;
...
import com.langitwallet.app.widget.CertifiedToolbarView;
        ...
        OnEthCallListener, OnWalletAddEthereumChainObjectListener, OnWalletActionListener
{
    ...
    private void showErrorDialogIncompatibleNetwork(long callbackId, long requestingChainId, long activeChainId)
    {
        if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED))
        {
            ...
            String message = com.langitwallet.app.repository.EthereumNetworkBase.isChainSupported(requestingChainId) ?
                    getString(R.string.error_eip712_incompatible_network,
                            com.langitwallet.app.repository.EthereumNetworkBase.getShortChainName(requestingChainId),
                            com.langitwallet.app.repository.EthereumNetworkBase.getShortChainName(activeChainId)) :
