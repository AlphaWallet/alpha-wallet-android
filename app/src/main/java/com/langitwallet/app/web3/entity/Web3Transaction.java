package com.langitwallet.app.web3.entity;
...
import com.langitwallet.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable
{
     ...
     * @param minGas
     */
    public Web3Transaction(com.langitwallet.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
