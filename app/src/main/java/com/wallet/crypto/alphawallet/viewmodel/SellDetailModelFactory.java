...
public class SellDetailModelFactory implements ViewModelProvider.Factory {
    ...
    public SellDetailModelFactory(FindDefaultWalletInteract findDefaultWalletInteract,
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new SellDetailModel(findDefaultWalletInteract, marketQueueService);
    }
}
