...
import io.awallet.crypto.alphawallet.ui.widget.OnDepositClickListener;

import static io.awallet.crypto.alphawallet.C.CHANGELLY_REF_ID;
import static io.awallet.crypto.alphawallet.C.COINBASE_WIDGET_CODE;
import static io.awallet.crypto.alphawallet.C.ETH_SYMBOL;
import static io.awallet.crypto.alphawallet.C.SHAPESHIFT_KEY;
