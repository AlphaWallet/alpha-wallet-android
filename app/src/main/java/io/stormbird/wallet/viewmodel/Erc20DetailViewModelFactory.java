...
public class Erc20DetailViewModelFactory implements ViewModelProvider.Factory {
    ...
    public Erc20DetailViewModelFactory(ConfirmationRouter confirmationRouter,
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new Erc20DetailViewModel(confirmationRouter, fetchGasSettingsInteract, myAddressRouter, fetchTokensInteract, ensInteract, assetDefinitionService);
    }
}
