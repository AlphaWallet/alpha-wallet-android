...
Each module has its own README. Please click the name of the module to go to the corresponding README file.
...
- If the user can't cover the transaction fee, the wallet app forwards the link to FeeMaster of corresponding asset-issuers, who may or may not send the transaction on behalf of its user.
